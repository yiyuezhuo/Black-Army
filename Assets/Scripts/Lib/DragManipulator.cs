...
public class DragManipulator : IManipulator
{
    ...
    public VisualElement target
    {
        ...
        set
        {
            ...
            /*
            _target.RegisterCallback<MouseDownEvent>((ev) => Debug.Log("MouseDownEvent"));

            _target.RegisterCallback<DragEnterEvent>((ev) => Debug.Log("DragEnterEvent"));
            _target.RegisterCallback<DragExitedEvent>((ev) => Debug.Log("DragExitedEvent"));
            _target.RegisterCallback<DragLeaveEvent>((ev) => Debug.Log("DragLeaveEvent"));
            _target.RegisterCallback<DragPerformEvent>((ev) => Debug.Log("DragPerformEvent"));
            _target.RegisterCallback<DragUpdatedEvent>((ev) => Debug.Log("DragUpdatedEvent"));
            */
